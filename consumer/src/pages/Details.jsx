...
const Details = () => {
  ...
  return (
    <div>
      <Header />
      <div className='bg-[url("http://localhost:3000/images/banner/shop1.jpg")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
        ...
        <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto pb-16">
          <div className="flex flex-wrap">
                ...
                <div>
                  {state === "reviews" ? (
                    ...
                    <p className="py-5 text-slate-600">
                      <h1 className="font-bold text-slate-800 text-2xl mb-4">
                        Buy Original {product.name} in Sri Lanka
                      </h1>
                      <h2 className="font-bold text-slate-700 text-xl mt-4">
                        Description
                      </h2>
                      {product.description}

                      {product?.mdescription && product.mdescription.trim() && (
                        <>
                          <h2 className="font-bold text-slate-700 text-xl mt-4">
                            Benefits
                          </h2>
            ...
            <div className="w-[28%] md-lg:w-full">
              <div className="pl-4 md-lg:pl-0 md:pt-10">
